 ...
 * @param style The style string (e.g., "Instagram").
 * @returns The fallback prompt string.
 */
function getFallbackPrompt(style: string): string {
    return `Create a high-resolution, square (1:1 aspect ratio) profile picture of the person in this image in a ${style} style. The photograph should be clear and well-lit. Ensure the final image is a clear photograph that looks great as a profile picture.`;
}

/**
 * Extracts the style (e.g., "Instagram") from a prompt string.
...
/**
 * Generates a styled profile picture from a source image and a prompt.
